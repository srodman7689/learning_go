...
func (repo *FakeUserRepository) Validate(user User) error {
	for _, u := range repo.DataStore {
		if u.Email == user.Email {
			return errors.New("The Email you specified already exists")
		}
	}
	return nil
}
...
func NewFakeUserRepo() *FakeUserRepository {
	return &FakeUserRepository{
		DataStore: []User{
			User{"Sean", "Rodman", "srodman7689@gmail.com"},
			User{"Tamara", "Rodman", "gothmoth03@yahoo.com"},
			User{"Rachel", "Rodman", "noemail@email.com"},
		},
	}
}
